 ...
 * as a stateless CMT session bean.
 */
...
public class QuoteServerEJB implements SessionBean, QuoteServer
   ...
   private PersistenceManager getPersistenceManager()
      ...
      {
      PersistenceManager pm = (PersistenceManager) cFactory.getConnection();
   ...
   private void msg(String m)
      {
      MsgCenter.putMsg("Stateless CMT QuoteServer (" + hashCode() + "): " + m);
      }

   private void msg(String m, Exception e)
      {
      MsgCenter.putException("Stateless CMT QuoteServer (" + hashCode() +
         "): " + m, e);
      }
